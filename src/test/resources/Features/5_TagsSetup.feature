...
Feature:Tags Setup
  ...
  Scenario Outline: User navigates to Tags Setup page and add a new Tag
    ...
    |ykadam+automationtester@kingsleygate.com| fSog0P3kEP03! | Testing136| #333  |Tag created successfully!|
  ...
  Scenario Outline: User navigates to Tags Setup page and deletes a Tag
    ...
    Examples:
      ...
      |ykadam+automationtester@kingsleygate.com| fSog0P3kEP03! | Testing136|